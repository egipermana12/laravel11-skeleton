        ...
        <div class="px-4 py-6 space-y-4">
            ...
            <div>
                ...
                <div class="flex items-start gap-2 w-full mt-1">
                    ...
                    <x-radio-label type="radio" name="radio-role" id="{{$role->name}}" wire:model="form.roles"
                        value="{{$role->name}}" class="mt-3">
                        <label for="{{$role->name}}"
                            class="w-full py-4 ms-2 text-sm font-medium text-gray-900 capitalize">{{$role->name}}
                        </label>
                    </x-radio-label>
                    @endforeach
                </div>
