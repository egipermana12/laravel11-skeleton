        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex items-center justify-between">
                    <h5 class="font-semibold text-gray-800">Daftar Anggota</h5>
                    <button wire:click="$dispatch('anggota-add-drawer')"
                        class="bg-gray-900 text-white font-semibold text-sm px-3 py-2 rounded-md hover:bg-gray-700">
                        <i class="fa-solid fa-circle-plus"></i>&nbsp;&nbsp;Add Anggota
                    </button>
                </div>

                <livewire:pages.anggota.anggota-table />
