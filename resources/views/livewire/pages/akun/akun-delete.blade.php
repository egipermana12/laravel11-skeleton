<x-modalcustom name="akun-delete" wire:model.live="openModalDelete">
    <form wire:submit.prevent="delete">
        @csrf
        <div class="px-4 py-6 space-y-4">
            <p>Apakah Anda yakin ingin menghapus data akun {{$this->form->akun_id}} ?</p>
        </div>
        <input type="hidden" name="akun_id" wire:model="form.akun_id">
