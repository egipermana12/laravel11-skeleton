        ...
        <table
            ...
            <tbody class="border-b border-gray-100 text-[13px]" wire.loading.class="opacity-50">
                ...
                <tr class="border-b border-gray-100 w-full " wire:key="{{$simpanan->simpanan_id}}">
                    ...
                    <td class="px-1 py-4 text-center">
                        <a href="{{ route('transaksianggota.simpanan.edit', $simpanan->simpanan_id) }}"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
