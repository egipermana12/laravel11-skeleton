                    ...
                    <div class="">
                        ...
                        <div class="flex gap-x-2 justify-end items-end mb-4">
                            <div class="w-1/2">
                                ...
                                <x-radio-label name="jenis_simpanan" type="radio" id="aktif"
                            ...
                            <div class="w-1/2">
                                <x-radio-label name="jenis_simpanan" type="radio" id="tidak aktif"
                            ...
                            <x-input-error class="mt-2 text-xs" :messages="$errors->get('form.jenis_simpanan')" />
                        </div>
